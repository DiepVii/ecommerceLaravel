		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					...
					<p class="pull-right">Designed by <span><a target="_blank" href="https://www.facebook.com/vi.diep.54584">Diệp Vĩ</a></span></p>
				</div>
			</div>
		</div>
		...
		$('.send-comment').click(function(){
			...
			$.ajax({
					...
					success:function(data){
						...
						$('#notify_comment').html('<p class="text text-success">Thêm bình luận thành công, Bình luận của bạn đang chờ duyệt</p>');
						load_comment();
						$('.comment_name').val('');
						$('.comment_content').val('');
